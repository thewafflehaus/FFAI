...
// dequant_gemv_int4 kernel end-to-end on Qwen3 1.7B.
//
...
@Suite("Qwen3 4-bit Integration", .serialized)
struct Quantized4bitIntegrationTests {
    ...
    func loadAndGenerate() async throws {
        ...
        expectCoherentOutput(result.generatedTokens, label: "Qwen3 1.7B 4-bit")
    }
}
