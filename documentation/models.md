...
| **Qwen 3.5 / 3.6** | Hybrid-Text | `qwen3_5`, `qwen3_5_moe` | 3.5 dense: 0.8B / 2B / 4B / 9B / 27B; 3.5 MoE: 35B-A3B / 122B-A10B / 397B-A17B; 3.6: 27B / 35B-A3B | bf16 / mxfp4 / 8 / 6 / 5 / 4 / 3 | Stack-interleaved Gated Delta Net ↔ attention; dense SwiGLU or block-sparse MoE with sigmoid-gated always-on shared expert. Gated attention (`attn_output_gate`), partial RoPE. Qwen 3.6 ships under the same `qwen3_5*` keys. |
