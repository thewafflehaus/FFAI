...
private let modelCatalog: [CatalogGroup] = [
    ...
    // ───────────────────────── SSM / GDN / Conv hybrid ─────────────────────────
    CatalogGroup(title: "SSM / GDN / Conv hybrid", entries: [
        // FalconH1.
        CatalogEntry(
    ...
    // ───────────────────────── Diffusion text ─────────────────────────
    CatalogGroup(title: "Diffusion text", entries: [
        CatalogEntry(
    ...
    // ───────────────────────── Vision-language ─────────────────────────
    CatalogGroup(title: "Vision-language", entries: [
        // Gemma 3 VL.
        CatalogEntry(
    ...
    // ───────────────────────── Audio (STT / TTS / Omni) ─────────────────────────
    CatalogGroup(title: "Audio (STT / TTS / Omni)", entries: [
        // Chatterbox TTS.
        CatalogEntry(
    ...
    CatalogGroup(title: "Voice activity / diarization", entries: [
        CatalogEntry(
